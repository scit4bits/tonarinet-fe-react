                      ...
                      {party.users.map((user) => (
                        <Avatar
                          ...
                          title={`${user.name}${
                            ...
                            user.isGranted === false
                              ? ` - ${t("common.pendingApproval")}`
                              : ""
                          }`}
                          sx={{
                            ...getStringAvatar(user.name).sx,
                            opacity: user.isGranted === false ? 0.4 : 1,
                            backgroundColor:
                              user.isGranted === false
                                ? "action.disabled"
                                : getStringAvatar(user.name).sx.bgcolor,
                            color:
                              user.isGranted === false
                                ? "text.disabled"
                                : "white",
                            border:
                              user.isGranted === false ? "2px dashed" : "none",
                            borderColor:
                              user.isGranted === false
                                ? "action.disabled"
                                : "transparent",
