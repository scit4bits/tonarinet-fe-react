export default function BoardWritePage(){
    return <div 
        className="flex flex-col items-center p-6 bg-pink-100 min-h-screen w-[1000px]">
        ...
        <div className="flex items-center gap-2 mb-2">
            ...
            <button type="button" className="bg-yellow-100 px-3 py-1 rounded">이모티콘</button>
            <button type="button" className="bg-yellow-100 px-3 py-1 rounded">차트</button>
            <button type="button" className="bg-yellow-100 px-3 py-1 rounded">투표</button>
        </div>
        ...
        <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex gap-2">
                ...
                <button type="submit" className="px-4 py-2 bg-pink-200 rounded hover:bg-pink-300">
                등록
                </button>
            </div>
        </div>
